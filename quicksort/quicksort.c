...
Since l is only increased if the value of arr[l] is less than or equal to the pivot,
you swap the address of the pivot with the address of decremented l. This gets the
pivot to where it would be equal to or greater than elements on the left and 
less than or equal to elements on the right.
If --l is 0, the first quicksort does not satisfy the if statement
